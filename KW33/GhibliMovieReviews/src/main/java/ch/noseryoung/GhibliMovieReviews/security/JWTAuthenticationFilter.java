...
import ch.noseryoung.GhibliMovieReviews.domain.users.UserService.UserDetailsImpl;
    ...
    private String generateToken(Authentication authResult) {
        ...
        return Jwts.builder()
                .setClaims(Map.of("sub", userDetailsImpl.user()
                        .getUserId(), "authorities", userDetailsImpl.getAuthorities()))
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            return getAuthenticationManager().authenticate(
                    new UsernamePasswordAuthenticationToken(credentials.getUserName(), credentials.getPs()));
        }
        catch (IOException e) {
